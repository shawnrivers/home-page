...
You can check the actual code from the WAI-ARIA alert example [here](https://www.w3.org/TR/wai-aria-practices-1.2/examples/alert/alert.html).
...
You can check the actual code from the WAI-ARIA switch example [here](https://www.w3.org/TR/wai-aria-practices-1.2/examples/switch/switch.html).
...
You can check the actual code from the WAI-ARIA tab example [here](https://www.w3.org/TR/wai-aria-practices-1.2/examples/tabs/tabs-1/tabs.html).
...
You can check the actual code from the WAI-ARIA menu example [here](https://www.w3.org/TR/wai-aria-practices-1.2/examples/menu-button/menu-button-actions.html).
