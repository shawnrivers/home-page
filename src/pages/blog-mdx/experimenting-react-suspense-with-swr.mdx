...
![](/blogs/experimenting-react-suspense-with-swr/Suspense_with_SWR.jpg)
...
![Post without Suspense GIF: first renders "Loading post..." placeholder, then swaps it with the actual data after the data comes in](/blogs/experimenting-react-suspense-with-swr/post-without-suspense.gif)
...
![Post with Suspense GIF: first renders "Loading post..." placeholder, then swaps it with the actual data after the data comes in](/blogs/experimenting-react-suspense-with-swr/post-with-suspense.gif)
