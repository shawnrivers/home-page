    ...
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0">
      <div
        className={cn(
          ...
          // align grid/dots origin consistently
          'bg-[position:50%_0,var(--frame-inset)_var(--frame-inset),var(--frame-inset)_var(--frame-inset),var(--frame-inset)_var(--frame-inset)]',
        )}
      />
    </div>
  );
